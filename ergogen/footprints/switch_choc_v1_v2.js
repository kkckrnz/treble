/** modified for treble keyboard
 *  - solder pin hole diameter modified for tighter fit: from 1.27 to 1.2
 *  - removed 'ceoloide:' from footprint name to remove DRC warning
 */
...
module.exports = {
  ...
  (footprint "switch_choc_v1_v2"
    ...
    // default drill was 1.27
    const solder_common = `
    (pad "2" thru_hole circle (at 0 ${solder_offset_y}5.9 ${195 + p.r}) (size 2.0 2.0) (drill 1.2) (layers "*.Cu" "*.Mask") ${p.from.str})
    `
    // default drill was 1.27
    const solder_front = `
    (pad "1" thru_hole circle (at ${solder_offset_x_front}5 ${solder_offset_y}3.8 ${195 + p.r}) (size 2.0 2.0) (drill 1.2) (layers "*.Cu" "*.Mask") ${p.to.str})
    `
    // default drill was 1.27
    const solder_back = `
    (pad "1" thru_hole circle (at ${solder_offset_x_back}5 ${solder_offset_y}3.8 ${195 + p.r}) (size 2.0 2.0) (drill 1.2) (layers "*.Cu" "*.Mask") ${p.to.str})
    `
