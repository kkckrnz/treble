 ...
 *  - 'O' for 'ON', 'X' for 'Off'. rotated 90 degrees
 *  - silkscreen outline removed
...
module.exports = {
  ...
  (footprint "power_switch_smd_side"
    ...
    (fp_text user "O" (at 0 ${p.invert_behavior ? '-' : ''}5 ${90 + p.r}) (layer "F.SilkS")
      (effects (font (size 1 1) (thickness 0.15)))
    )
    (fp_text user "X" (at 0 ${p.invert_behavior ? '' : '-'}5 ${90 + p.r}) (layer "F.SilkS")
      (effects (font (size 1 1) (thickness 0.15)))
    )
    `
